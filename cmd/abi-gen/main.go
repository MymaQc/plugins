...
func main() {
	...
	outputs := map[string][]byte{
		filepath.Join(*root, "abi", "include", "dragonfly_plugin.h"):                         generateC(events, player.States),
		filepath.Join(*root, "rust", "dragonfly-plugin-sys", "src", "generated.rs"):          generateRust(events, player.States),
		filepath.Join(*root, "internal", "host", "player_state_generated.go"):                generateGoPlayerStates(player.States),
		filepath.Join(*root, "internal", "native", "player_state_generated.go"):              generateGoNativePlayerStates(player.States),
		filepath.Join(*root, "rust", "dragonfly-plugin", "src", "player_state_generated.rs"): generateRustPlayerStates(player.States),
	}
...
func generateC(events []event, states []playerState) []byte {
	var b bytes.Buffer
...
func generateRust(events []event, states []playerState) []byte {
	var b bytes.Buffer
	fmt.Fprintf(&b, "// Code generated by abi-gen v%s. DO NOT EDIT.\n\n", generatorVersion)
...
func generateGoNativePlayerStates(states []playerState) []byte {
	var b bytes.Buffer
	fmt.Fprintf(&b, "// Code generated by abi-gen v%s. DO NOT EDIT.\n\n", generatorVersion)
...
func generateRustPlayerStates(states []playerState) []byte {
	var b bytes.Buffer
	fmt.Fprintf(&b, "// Code generated by abi-gen v%s. DO NOT EDIT.\n\n", generatorVersion)

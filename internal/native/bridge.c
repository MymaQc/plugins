...
_Static_assert(sizeof(DfHostApiV27) == 1056, "DfHostApiV27 ABI layout changed");
_Static_assert(DF_HOST_ABI_VERSION == 60u, "host ABI version changed without bridge review");

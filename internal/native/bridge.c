...
_Static_assert(sizeof(DfHostApiV16) == 456, "DfHostApiV16 ABI layout changed");
...
_Static_assert(offsetof(DfHostApiV16, world_open_spec) == 448, "DfHostApiV16.world_open_spec ABI offset changed");
#endif

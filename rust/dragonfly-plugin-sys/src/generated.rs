...
pub const DF_PLAYER_OPERATION_EXPERIENCE: u32 = 2;
...
pub type DfHostPlayerExperienceSetFn = unsafe extern "C" fn(context: u64, invocation: DfInvocationId, player: DfPlayerId, level: i32, progress: f64) -> DfStatus;
